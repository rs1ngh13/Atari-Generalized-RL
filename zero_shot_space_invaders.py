...
checkpoint = "/Users/rajdeepsingh/Documents/School/Masters/Spring 2025/DS543 Reinforcement Learning/final_project/multihead_transfer_proportional_dqn.pth"
...
print(f"Loaded {len(filtered)}/{len(loaded)} params")
